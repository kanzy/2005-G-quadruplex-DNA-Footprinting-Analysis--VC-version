...
void CSteepdnFsolver::CalR7Mode(double P1, double P2, double P3, double P4, double P5, double P6)
{
	...
	double* x;
	x=new double[6];
	x[0]=p; x[1]=R; x[2]=Q1; x[3]=Q2; x[4]=Q3; x[5]=Q4;
	int i,j,k,maxiter=10000;
	double alpha,gtg,dfgtdfg,normf0,normf1;
	static double fk[7],Df[7][6],xx[6],g[6],dfg[7];//
	k=0;	//iter count
...
void CSteepdnFsolver::CalR6Mode(double P1,double P2,double P3,double P4,double P5)
{
	...
	double* x;
	x=new double[5];
	x[0]=p; x[1]=R; x[2]=Q1; x[3]=Q2; x[4]=Q3;
	int i,j,k,maxiter=10000;
	double alpha,gtg,dfgtdfg,normf0,normf1;
	static double fk[6],Df[6][5],xx[5],g[5],dfg[6];//
	k=0;	//iter count
...
void CSteepdnFsolver::CalR5Mode(double P1,double P2,double P3,double P4)
{
	...
	double* x;
	x=new double[4];
	x[0]=p; x[1]=R; x[2]=Q1; x[3]=Q2;
	int i,j,k,maxiter=10000;
	double alpha,gtg,dfgtdfg,normf0,normf1;
	static double fk[5],Df[5][4],xx[4],g[4],dfg[5];//
	k=0;	//iter count
