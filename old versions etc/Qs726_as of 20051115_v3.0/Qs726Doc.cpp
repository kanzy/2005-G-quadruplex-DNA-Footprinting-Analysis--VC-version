...
BOOL CQs726Doc::OnNewDocument()
{
	...
	m_DocResult_p=0;
	m_DocResult_q=0;	//2005-11-15 addition
	m_DocResult_R=0;
	m_DocResult_Q1=0;
	m_DocResult_Q2=0;
	m_DocResult_Q3=0;
...
void CQs726Doc::Serialize(CArchive& ar)
{
	if (ar.IsStoring())
	{
		// TODO: add storing code here; 2005-11-15 modification here
		ar<<m_DocBand1<<m_DocBand2<<m_DocBand3<<m_DocBand4<<m_DocBand5<<m_DocBand6
		   <<m_DocRefLane<<m_DocRefRatio<<m_DocResult_p<<m_DocResult_q<<m_DocResult_R<<m_DocResult_Q1
		   <<m_DocResult_Q2<<m_DocResult_Q3<<m_DocResult_Q4;
	}
	else
	{
		// TODO: add loading code here; 2005-11-15 modification here
		ar>>m_DocBand1>>m_DocBand2>>m_DocBand3>>m_DocBand4>>m_DocBand5>>m_DocBand6
		   >>m_DocRefLane>>m_DocRefRatio>>m_DocResult_p>>m_DocResult_q>>m_DocResult_R>>m_DocResult_Q1
		   >>m_DocResult_Q2>>m_DocResult_Q3>>m_DocResult_Q4;
	}
