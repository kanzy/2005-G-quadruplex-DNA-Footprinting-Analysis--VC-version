...
void CQs726View::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_EDIT21, m_IniVal_q);
	DDX_Text(pDX, IDC_EDIT22, m_Result_q);
	//}}AFX_DATA_MAP
}
...
void CQs726View::OnInitialUpdate()
{
	...
	m_Result_q=pDoc->m_DocResult_q;	//2005-11-15 addition
...
void CQs726View::OnCalculate() 
{
	...
	myFsolver->q=m_IniVal_q;	//2005-11-15 addition
	...
	m_Result_q=myFsolver->q;	//2005-11-15 addition
	...
	pDoc->m_DocResult_q=m_Result_q;	//2005-11-15 addition
...
void CQs726View::OnButton1() //"Get Default" Button
{
	...
	m_IniVal_q=0;		//2005-11-15 addition
